<template>
  <div
    ref="topBarRef"
    class="bg-base-100 md:bg-base-100/80 need-blur border-base-300/50 sticky z-10 flex min-w-0 items-center gap-1 overflow-hidden shadow transition-all duration-300 md:backdrop-blur-xl"
